...
import type { StudentDepartmentData } from "@/components/dashboard/StudentsDepartmentCard";

interface ChartProps {
  data: StudentDepartmentData[];
}

export function ChartBarStackedStudentsDepartment({ data }: ChartProps) {
